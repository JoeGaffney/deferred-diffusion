...
@REM call :CopyModelDir ".locks"
@REM call :CopyModelDir "models--XLabs-AI--flux-controlnet-canny-v3"
@REM call :CopyModelDir "models--black-forest-labs--FLUX.1-schnell"
@REM call :CopyModelDir "models--city96--FLUX.1-schnell-gguf"
@REM call :CopyModelDir "models--depth-anything--Depth-Anything-V2-Large-hf"
@REM call :CopyModelDir "models--diffusers--controlnet-canny-sdxl-1.0-small"
@REM call :CopyModelDir "models--diffusers--controlnet-depth-sdxl-1.0-small"
@REM call :CopyModelDir "models--facebook--sam-vit-base"
@REM call :CopyModelDir "models--fluently--Fluently-XL-v4"
@REM call :CopyModelDir "models--h94--IP-Adapter"
@REM call :CopyModelDir "models--SG161222--RealVisXL_V4.0"
@REM call :CopyModelDir "models--Lightricks--LTX-Video-0.9.5"
@REM call :CopyModelDir "models--Qwen--Qwen2.5-VL-3B-Instruct"

REM REMAINING MODELS
